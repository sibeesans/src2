...
wget -q -O /usr/bin/cek-user "https://raw.githubusercontent.com/myridwan/src/ipuk/xray/cek-ws.sh" && chmod +x /usr/bin/cek-user
wget -q -O /usr/bin/renew-user "https://raw.githubusercontent.com/myridwan/src/ipuk/xray/renew-ws.sh" && chmod +x /usr/bin/renew-user
